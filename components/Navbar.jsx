...
export default function Navbar(props) {
  ...
  // Corrected route for Admin Login
  const goToAdmin = () => {
    navigate('/admin-login'); // Admin Login page route
  }
        ...
        <div className='flex gap-8'>
          ...
          <div className='flex items-center gap-5'>
            <button
              ...
              onClick={() => props.managePanel('wishlist')}
            >
              <FaHeart />
              {props.wish.length > 0 && (
            ...
            <button
              ...
              onClick={() => props.managePanel('cart')}
            >
              <FaShoppingBag />
              {props.total > 0 && (
